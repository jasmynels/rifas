...
export function SoloPrize(props) {
    const { onSubmitRifas, rifaValue, setRifaValue, qtd, setQtd  } = useContext(AuthContext)
            ...
            <section className='solo-prize'>
                ...
                <div className='buy-total'>
                    <form onSubmit={handleSubmit}>
                        ...
                        <Link to="/carrinho" className='link'> <BiCheckCircle /> Parcitipar do sorteio <span> R${rifaValue},00 </span></Link>
                    </form>
                </div>
            </section>   
       </>
